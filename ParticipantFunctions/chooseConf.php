...
<form action="Participate.php" method="post" name="pForm" id="participation" >
		<fieldset>
			...
			<?php 
				...
				echo "<select name=\"pConference\" id=\"pConference\" style=\"font-size:20px;width:100%;\"	>";//creates a select option dropdown box
