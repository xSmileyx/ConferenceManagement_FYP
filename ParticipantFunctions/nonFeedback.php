...
<form action="" method="post" name="fForm" id="feedback" >
			<fieldset id="chooseConf">
				...
				Name:
					<input type="text" name="feedName" class="twitter" id="feedName" autocomplete=off required><br><br>
				
				Subject:<br> 
					<input type="text" name="feedSubject" class="twitter" id="feedSubject" autocomplete=off required><br><br>
					
				Comment:<br>
					<textarea name="feedText" id="feedText" class="twitter" style="width:100%; height:200px;" autocomplete=off required></textarea><br><br>
							
							
				<input type="submit" name="submit" class="button" onclick="return alert('Thank you for the feedback!')" value="Send">
