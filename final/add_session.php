...
<div id="body">
        ...
        <tr>
            ...
            <tr>
                    <td></td>
                	<td colspan=2><div style="float:left;"><input type="submit" name="submit" value="Submit"/></div><div style="text-align:center;"><input type="reset" name="reset" value="Clear"/></div></td>          
			</tr>        
        </table>
        </form>
    </div>
