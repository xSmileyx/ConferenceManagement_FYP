...
<title>Delete Speaker List</title>
...
echo '<td>'.$row[1].'</td>';
echo '<td>'.$row[2].'</td>';
echo "<td><form method='post' action='deletespeaker.php'><input type='hidden' name='speaker_id' value='".$row[0]."'><input type='submit' value='Delete'></form></td>";
echo '</tr>';
}
echo '</table>';
