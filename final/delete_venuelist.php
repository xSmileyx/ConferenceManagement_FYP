...
echo '<td>'.$row[2].'</td>';
echo '<td>'.$row[3].'</td>';
echo "<td><form method='post' action='deletevenue.php'><input type='hidden' name='venue_id' value='".$row[0]."'><input type='submit' value='Delete'></form></td>";
echo '</tr>';
}
echo '</table>';
