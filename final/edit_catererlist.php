...
echo '<td>'.$row[2].'</td>';
echo '<td>'.$row[3].'</td>';
echo "<td><form method='post' action='edit_caterer.php'><input type='hidden' name='caterer_id' value='".$row[0]."'><input type='submit' value='Edit'></form></td>";
echo '</tr>';
}
echo '</table>';
