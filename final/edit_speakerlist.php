...
echo '<td>'.$row[1].'</td>';
echo '<td>'.$row[2].'</td>';
echo "<td><form method='post' action='edit_speaker.php'><input type='hidden' name='speaker_id' value='".$row[0]."'><input type='submit' value='Edit'></form></td>";
echo '</tr>';
}
echo '</table>';
