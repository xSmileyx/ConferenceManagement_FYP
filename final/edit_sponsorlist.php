...
echo '<td>'.$row[2].'</td>';
echo '<td>'.$row[3].'</td>';
echo "<td><form method='post' action='edit_sponsor.php'><input type='hidden' name='sponsor_id' value='".$row[0]."'><input type='submit' value='Edit'></form></td>";
echo '</tr>';
}
echo '</table>';
