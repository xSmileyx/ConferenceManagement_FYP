    ...
    <h1 align="center">Add Pass Type</h1>
		<form action="addpasstype.php" method="post">
            ...
            <tr>
                ...
                <tr>
                	<td></td>
                	<td><div style="float:left;"><input type="submit" name="submit" class="button" value="Submit"/>
                    	</div><div style="text-align:center;"><input type="reset" name="reset" class="button" value="Clear"/><div></td>
                </tr>
