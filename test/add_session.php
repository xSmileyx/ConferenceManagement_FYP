    ...
    <div class="content three_quarter first"> 
      <div class="scrollable">
        ...
        <tr>
            ...
            <tr>
                    <td></td>
                	<td colspan=2><div style="float:left;"><input type="submit" name="submit" class="button" value="Submit"/></div>
                    				<div style="text-align:center;"><input type="reset" name="reset" class="button" value="Clear"/></div>
                                    </td>          
			</tr>        
        </table>
        </form>
