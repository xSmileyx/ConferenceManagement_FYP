...
echo '<h2 style="color: blue;font-family: arial" align=center>List of conferences</h2>';
...
echo '<td>'.$row[3].'</td>';
echo '<td>'.$row[8].'</td>';
echo "<td><form method='post' action='deleteconference.php'><input type='hidden' name='conf_id' value='".$row[0]."'><input type='submit' class='button' value='Delete'></form></td>";
echo '</tr>';
}
echo '</table>';
