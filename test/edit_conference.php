    ...
    <h1 align="center">Add Conference</h1>
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td colspan="2"><input type="date" name="conf_startdate" class="twitter" value="<?php echo $row[2];?>"  required /></td>
            </tr>
            <tr>
            	<td align="left" valign="middle"><p>Conference end date</p></td>
                <td colspan="2"><input type="date" name="conf_enddate" class="twitter" value="<?php echo $row[3];?>"  required /></td>
            </tr>
            <tr>
