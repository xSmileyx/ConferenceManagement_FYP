...
$query="SELECT * FROM tblconference" ;
...
echo '<td>Conference Name name &nbsp;&nbsp;&nbsp;</td>';
echo '</tr>';
...
echo "<td>	<form method='post' action='viewsession.php'><input type='hidden' name='conf_id' value='".$row[0]."'>
				<input type='submit' class='button1' value='View sessions'>
			</form>
	</td>";
	
echo "<td>	<form method='post' action='viewconfspeaker.php'><input type='hidden' name='conf_id' value='".$row[0]."'>
				<input type='submit' class='button1' value='View Speakers'>
			</form>
	</td>";
	
echo "<td>	<form method='post' action='viewconfsponsor.php'><input type='hidden' name='conf_id' value='".$row[0]."'>
				<input type='submit' class='button1' value='View sponsors'>
			</form>
	</td>";
	
echo "<td>	<form method='post' action='viewconfpass.php'><input type='hidden' name='conf_id' value='".$row[0]."'>
				<input type='submit' class='button1' value='View pass types'>
			</form>
	</td>";
